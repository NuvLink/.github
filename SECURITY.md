...
Se você encontrar uma vulnerabilidade de segurança em qualquer repositório da NuvLink, **não abra uma issue pública**. Envie um e-mail para `security@nuvlink.io` (ajustar para o e-mail real da empresa) com:
